    ...
    return (
        <View style={styles.tastiera}>
            <View style={styles.riga_tasti}>
                <Tasto caption="AC"/><Tasto caption="&plusmn;"/><Tasto caption="%"/><Tasto caption="&divide;"/>
            </View>
            <View style={styles.riga_tasti}>
                <Tasto caption="7"/><Tasto caption="8"/><Tasto caption="9"/><Tasto caption="&times;"/>
            </View>
            <View style={styles.riga_tasti}>
                <Tasto caption="4"/><Tasto caption="5"/><Tasto caption="6"/><Tasto caption="&ndash;"/>
            </View>
            <View style={styles.riga_tasti}>
